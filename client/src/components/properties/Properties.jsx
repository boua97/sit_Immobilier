        ...
        {filteredProperties?.length > 0 ?
          <>
            <div className={classes.titles}>
              <h5>Propriétés sélectionnées</h5>
              <h2>Propriété qui pourrait vous plaire</h2>
            </div>
          ...
          </> : <h2 className={classes.noProperty}>Nous n'avons pas de propriétés avec les options spécifiées.</h2>}
      </div>
    </div>
  )
}
